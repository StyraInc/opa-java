...
import com.styra.opa.models.operations.SDKMethodInterfaces.*;
...
public class Opa implements
    ...
    public com.styra.opa.models.operations.ExecutePolicyResponse executePolicy(
        ...
        String url = com.styra.opa.utils.Utils.generateURL(
                com.styra.opa.models.operations.ExecutePolicyRequest.class,
                baseUrl,
                "/v1/data/{path}",
                request, null);
        ...
        java.util.List<NameValuePair> queryParams = com.styra.opa.utils.Utils.getQueryParams(
                com.styra.opa.models.operations.ExecutePolicyRequest.class, request, null);
        if (queryParams != null) {
        ...
        com.styra.opa.models.operations.ExecutePolicyResponse.Builder resBuilder = 
            com.styra.opa.models.operations.ExecutePolicyResponse
                .builder()
                .contentType(contentType)
                .statusCode(httpRes.statusCode())
                .rawResponse(httpRes);

        com.styra.opa.models.operations.ExecutePolicyResponse res = resBuilder.build();
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (com.styra.opa.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                com.styra.opa.models.shared.SuccessfulPolicyEvaluation out = mapper.readValue(
                    Utils.toUtf8AndClose(httpRes.body()),
                    new TypeReference<com.styra.opa.models.shared.SuccessfulPolicyEvaluation>() {});
            ...
            if (com.styra.opa.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                com.styra.opa.models.shared.ClientError out = mapper.readValue(
                    Utils.toUtf8AndClose(httpRes.body()),
                    new TypeReference<com.styra.opa.models.shared.ClientError>() {});
            ...
            if (com.styra.opa.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                com.styra.opa.models.shared.ServerError out = mapper.readValue(
                    Utils.toUtf8AndClose(httpRes.body()),
                    new TypeReference<com.styra.opa.models.shared.ServerError>() {});
    ...
    public com.styra.opa.models.operations.ExecutePolicyWithInputResponse executePolicyWithInput(
        ...
        String url = com.styra.opa.utils.Utils.generateURL(
                com.styra.opa.models.operations.ExecutePolicyWithInputRequest.class,
                baseUrl,
                "/v1/data/{path}",
                request, null);
        ...
        Object _convertedRequest = Utils.convertToShape(request, Utils.JsonShape.DEFAULT,
            new TypeReference<com.styra.opa.models.operations.ExecutePolicyWithInputRequest>() {});
        SerializedBody serializedRequestBody = com.styra.opa.utils.Utils.serializeRequestBody(
        ...
        java.util.List<NameValuePair> queryParams = com.styra.opa.utils.Utils.getQueryParams(
                com.styra.opa.models.operations.ExecutePolicyWithInputRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        String contentType = httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.styra.opa.models.operations.ExecutePolicyWithInputResponse.Builder resBuilder = 
            com.styra.opa.models.operations.ExecutePolicyWithInputResponse
                .builder()
                .contentType(contentType)
                .statusCode(httpRes.statusCode())
                .rawResponse(httpRes);

        com.styra.opa.models.operations.ExecutePolicyWithInputResponse res = resBuilder.build();
    ...
    public com.styra.opa.models.operations.HealthResponse health(
        ...
        com.styra.opa.models.operations.HealthRequest request =
            com.styra.opa.models.operations.HealthRequest
                .builder()
                .bundles(bundles)
                .plugins(plugins)
        ...
        java.util.List<NameValuePair> queryParams = com.styra.opa.utils.Utils.getQueryParams(
                com.styra.opa.models.operations.HealthRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        String contentType = httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.styra.opa.models.operations.HealthResponse.Builder resBuilder = 
            com.styra.opa.models.operations.HealthResponse
                .builder()
                .contentType(contentType)
                .statusCode(httpRes.statusCode())
                .rawResponse(httpRes);

        com.styra.opa.models.operations.HealthResponse res = resBuilder.build();
        ...
        if (httpRes.statusCode() == 200) {
            if (com.styra.opa.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                com.styra.opa.models.shared.HealthyServer out = mapper.readValue(
                    Utils.toUtf8AndClose(httpRes.body()),
                    new TypeReference<com.styra.opa.models.shared.HealthyServer>() {});
            ...
            if (com.styra.opa.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                com.styra.opa.models.shared.UnhealthyServer out = mapper.readValue(
                    Utils.toUtf8AndClose(httpRes.body()),
                    new TypeReference<com.styra.opa.models.shared.UnhealthyServer>() {});
