...
import com.styra.opa.openapi.models.operations.CompileQueryWithPartialEvaluationRequest;
import com.styra.opa.openapi.models.operations.CompileQueryWithPartialEvaluationRequestBuilder;
import com.styra.opa.openapi.models.operations.CompileQueryWithPartialEvaluationResponse;
...
public class OpaApiClient implements
            ...
            MethodCallCompileQueryWithPartialEvaluation,
            MethodCallHealth {
    ...
    public static class Builder {
        ...
        Builder _hooks(com.styra.opa.openapi.utils.Hooks hooks) {
            sdkConfiguration.setHooks(hooks);  
            return this;  
        }
        
        // Visible for testing, may be accessed via reflection in tests
        Builder _hooks(Consumer<? super com.styra.opa.openapi.utils.Hooks> consumer) {
     ...
     * @return The call builder
     */
    public CompileQueryWithPartialEvaluationRequestBuilder compileQueryWithPartialEvaluation() {
        return new CompileQueryWithPartialEvaluationRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public CompileQueryWithPartialEvaluationResponse compileQueryWithPartialEvaluation(
            CompileQueryWithPartialEvaluationRequest request) throws Exception {
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                CompileQueryWithPartialEvaluationRequest.class,
                _baseUrl,
                "/v1/compile/{path}",
                request, null);
        ...
        Object _convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<CompileQueryWithPartialEvaluationRequest>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, 
                "requestBody",
                "json",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        CompileQueryWithPartialEvaluationResponse.Builder _resBuilder = 
        ...
        CompileQueryWithPartialEvaluationResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                CompileResultJSON _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultJSON>() {});
                _res.withCompileResultJSON(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.multitarget+json")) {
                CompileResultMultitarget _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultMultitarget>() {});
                _res.withCompileResultMultitarget(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.ucast.all+json")) {
                CompileResultUCAST _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultUCAST>() {});
                _res.withCompileResultUCAST(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.ucast.linq+json")) {
                CompileResultUCAST _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultUCAST>() {});
                _res.withCompileResultUCAST(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.ucast.minimal+json")) {
                CompileResultUCAST _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultUCAST>() {});
                _res.withCompileResultUCAST(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.ucast.prisma+json")) {
                CompileResultUCAST _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultUCAST>() {});
                _res.withCompileResultUCAST(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.sql.mysql+json")) {
                CompileResultSQL _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultSQL>() {});
                _res.withCompileResultSQL(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.sql.postgresql+json")) {
                CompileResultSQL _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultSQL>() {});
                _res.withCompileResultSQL(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.sql.sqlite+json")) {
                CompileResultSQL _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultSQL>() {});
                _res.withCompileResultSQL(Optional.ofNullable(_out));
                return _res;
            } else if (Utils.contentTypeMatches(_contentType, "application/vnd.styra.sql.sqlserver+json")) {
                CompileResultSQL _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<CompileResultSQL>() {});
                _res.withCompileResultSQL(Optional.ofNullable(_out));
     ...
     * 
     * <p>The health API endpoint executes a simple built-in policy query to verify that the server is operational. Optionally it can account for bundle activation as well (useful for “ready” checks at startup).
     * 
     * @return The call builder
     */
