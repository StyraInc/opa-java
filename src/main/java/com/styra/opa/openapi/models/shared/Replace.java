...
@JsonDeserialize(using = Replace._Deserializer.class)
public class Replace {

    @JsonValue
    private TypedObject value;
    
    private Replace(TypedObject value) {
        this.value = value;
    }

    public static Replace of(boolean value) {
        Utils.checkNotNull(value, "value");
        return new Replace(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<java.lang.Boolean>(){}));
    }

    public static Replace of(String value) {
        Utils.checkNotNull(value, "value");
        return new Replace(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<String>(){}));
    }

    public static Replace of(double value) {
        Utils.checkNotNull(value, "value");
        return new Replace(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<java.lang.Double>(){}));
    }

    public static Replace of(List<Object> value) {
        Utils.checkNotNull(value, "value");
        return new Replace(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<Object>>(){}));
    }

    public static Replace of(Map<String, Object> value) {
        Utils.checkNotNull(value, "value");
        return new Replace(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<Map<String, Object>>(){}));
    }
    ...
    public String toString() {
        return Utils.toString(Replace.class,
                "value", value);
    }
