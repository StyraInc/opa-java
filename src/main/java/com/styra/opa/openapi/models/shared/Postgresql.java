...
public class Postgresql {
     ...
     * String representing the SQL equivalent of the conditions under which the query is true
     */
    public Postgresql withQuery(String query) {
        Utils.checkNotNull(query, "query");
     ...
     * String representing the SQL equivalent of the conditions under which the query is true
     */
    public Postgresql withQuery(Optional<String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
     ...
     * Column masking rules, where the first two nested keys represent the table name and the column name, and the value describes which masking function to use.
     */
    public Postgresql withMasks(Map<String, Map<String, MaskingRule>> masks) {
        Utils.checkNotNull(masks, "masks");
     ...
     * Column masking rules, where the first two nested keys represent the table name and the column name, and the value describes which masking function to use.
     */
    public Postgresql withMasks(Optional<? extends Map<String, Map<String, MaskingRule>>> masks) {
        Utils.checkNotNull(masks, "masks");
        this.masks = masks;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Postgresql.class,
                "query", query,
                "masks", masks);
    }
