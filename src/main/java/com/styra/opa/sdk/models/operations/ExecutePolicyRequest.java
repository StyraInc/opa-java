...
public class ExecutePolicyRequest {
     ...
     * Indicates the server should respond with a gzip encoded body. The server will send the compressed response only if its length is above `server.encoding.gzip.min_length` value. See the configuration section
     */
    public ExecutePolicyRequest withAcceptEncoding(com.styra.opa.sdk.models.shared.GzipAcceptEncoding acceptEncoding) {
        Utils.checkNotNull(acceptEncoding, "acceptEncoding");
     ...
     * Indicates the server should respond with a gzip encoded body. The server will send the compressed response only if its length is above `server.encoding.gzip.min_length` value. See the configuration section
     */
    public ExecutePolicyRequest withAcceptEncoding(Optional<? extends com.styra.opa.sdk.models.shared.GzipAcceptEncoding> acceptEncoding) {
        Utils.checkNotNull(acceptEncoding, "acceptEncoding");
        this.acceptEncoding = acceptEncoding;
        return this;
    }
     ...
     * Return query explanation in addition to result.
     */
    public ExecutePolicyRequest withExplain(com.styra.opa.sdk.models.shared.Explain explain) {
        Utils.checkNotNull(explain, "explain");
     ...
     * Return query explanation in addition to result.
     */
    public ExecutePolicyRequest withExplain(Optional<? extends com.styra.opa.sdk.models.shared.Explain> explain) {
        Utils.checkNotNull(explain, "explain");
        this.explain = explain;
        return this;
    }
