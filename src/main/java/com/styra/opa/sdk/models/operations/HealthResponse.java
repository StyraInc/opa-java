...
public class HealthResponse implements com.styra.opa.sdk.utils.Response {
     ...
     * OPA service is healthy. If the bundles option is specified then all configured bundles have been activated. If the plugins option is specified then all plugins are in an OK state.
     */
    public HealthResponse withHealthyServer(com.styra.opa.sdk.models.shared.HealthyServer healthyServer) {
        Utils.checkNotNull(healthyServer, "healthyServer");
     ...
     * OPA service is healthy. If the bundles option is specified then all configured bundles have been activated. If the plugins option is specified then all plugins are in an OK state.
     */
    public HealthResponse withHealthyServer(Optional<? extends com.styra.opa.sdk.models.shared.HealthyServer> healthyServer) {
        Utils.checkNotNull(healthyServer, "healthyServer");
        this.healthyServer = healthyServer;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * OPA service is healthy. If the bundles option is specified then all configured bundles have been activated. If the plugins option is specified then all plugins are in an OK state.
         */
        public Builder healthyServer(com.styra.opa.sdk.models.shared.HealthyServer healthyServer) {
            Utils.checkNotNull(healthyServer, "healthyServer");
            this.healthyServer = Optional.ofNullable(healthyServer);
            return this;
        }
         ...
         * OPA service is healthy. If the bundles option is specified then all configured bundles have been activated. If the plugins option is specified then all plugins are in an OK state.
         */
        public Builder healthyServer(Optional<? extends com.styra.opa.sdk.models.shared.HealthyServer> healthyServer) {
            Utils.checkNotNull(healthyServer, "healthyServer");
            this.healthyServer = healthyServer;
            return this;
        }
