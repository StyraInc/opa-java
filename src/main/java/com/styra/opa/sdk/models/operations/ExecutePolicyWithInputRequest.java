...
public class ExecutePolicyWithInputRequest {
    ...
    private Optional<? extends com.styra.opa.sdk.models.shared.GzipContentEncoding> contentEncoding;
    ...
    private Optional<? extends com.styra.opa.sdk.models.shared.GzipAcceptEncoding> acceptEncoding;
    ...
    private Optional<? extends com.styra.opa.sdk.models.shared.Explain> explain;
    ...
    public ExecutePolicyWithInputRequest(
            ...
            Optional<? extends com.styra.opa.sdk.models.shared.Explain> explain,
     ...
     * Indicates that the request body is gzip encoded
     */
    public ExecutePolicyWithInputRequest withContentEncoding(com.styra.opa.sdk.models.shared.GzipContentEncoding contentEncoding) {
        Utils.checkNotNull(contentEncoding, "contentEncoding");
     ...
     * Indicates that the request body is gzip encoded
     */
    public ExecutePolicyWithInputRequest withContentEncoding(Optional<? extends com.styra.opa.sdk.models.shared.GzipContentEncoding> contentEncoding) {
        Utils.checkNotNull(contentEncoding, "contentEncoding");
        this.contentEncoding = contentEncoding;
        return this;
    }
     ...
     * Indicates the server should respond with a gzip encoded body. The server will send the compressed response only if its length is above `server.encoding.gzip.min_length` value. See the configuration section
     */
    public ExecutePolicyWithInputRequest withAcceptEncoding(com.styra.opa.sdk.models.shared.GzipAcceptEncoding acceptEncoding) {
        Utils.checkNotNull(acceptEncoding, "acceptEncoding");
     ...
     * Indicates the server should respond with a gzip encoded body. The server will send the compressed response only if its length is above `server.encoding.gzip.min_length` value. See the configuration section
     */
    public ExecutePolicyWithInputRequest withAcceptEncoding(Optional<? extends com.styra.opa.sdk.models.shared.GzipAcceptEncoding> acceptEncoding) {
        Utils.checkNotNull(acceptEncoding, "acceptEncoding");
        this.acceptEncoding = acceptEncoding;
        return this;
    }
     ...
     * Return query explanation in addition to result.
     */
    public ExecutePolicyWithInputRequest withExplain(com.styra.opa.sdk.models.shared.Explain explain) {
        Utils.checkNotNull(explain, "explain");
     ...
     * Return query explanation in addition to result.
     */
    public ExecutePolicyWithInputRequest withExplain(Optional<? extends com.styra.opa.sdk.models.shared.Explain> explain) {
        Utils.checkNotNull(explain, "explain");
        this.explain = explain;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends com.styra.opa.sdk.models.shared.GzipContentEncoding> contentEncoding = Optional.empty();
 
        private Optional<? extends com.styra.opa.sdk.models.shared.GzipAcceptEncoding> acceptEncoding = Optional.empty();
 
        private Optional<? extends Boolean> pretty = Optional.empty();
 
        private Optional<? extends Boolean> provenance = Optional.empty();
 
        private Optional<? extends com.styra.opa.sdk.models.shared.Explain> explain = Optional.empty();
         ...
         * Indicates that the request body is gzip encoded
         */
        public Builder contentEncoding(com.styra.opa.sdk.models.shared.GzipContentEncoding contentEncoding) {
            Utils.checkNotNull(contentEncoding, "contentEncoding");
            this.contentEncoding = Optional.ofNullable(contentEncoding);
            return this;
        }
         ...
         * Indicates that the request body is gzip encoded
         */
        public Builder contentEncoding(Optional<? extends com.styra.opa.sdk.models.shared.GzipContentEncoding> contentEncoding) {
            Utils.checkNotNull(contentEncoding, "contentEncoding");
            this.contentEncoding = contentEncoding;
            return this;
        }
         ...
         * Indicates the server should respond with a gzip encoded body. The server will send the compressed response only if its length is above `server.encoding.gzip.min_length` value. See the configuration section
         */
        public Builder acceptEncoding(com.styra.opa.sdk.models.shared.GzipAcceptEncoding acceptEncoding) {
            Utils.checkNotNull(acceptEncoding, "acceptEncoding");
            this.acceptEncoding = Optional.ofNullable(acceptEncoding);
            return this;
        }
         ...
         * Indicates the server should respond with a gzip encoded body. The server will send the compressed response only if its length is above `server.encoding.gzip.min_length` value. See the configuration section
         */
        public Builder acceptEncoding(Optional<? extends com.styra.opa.sdk.models.shared.GzipAcceptEncoding> acceptEncoding) {
            Utils.checkNotNull(acceptEncoding, "acceptEncoding");
            this.acceptEncoding = acceptEncoding;
            return this;
        }
         ...
         * Return query explanation in addition to result.
         */
        public Builder explain(com.styra.opa.sdk.models.shared.Explain explain) {
            Utils.checkNotNull(explain, "explain");
            this.explain = Optional.ofNullable(explain);
            return this;
        }
         ...
         * Return query explanation in addition to result.
         */
        public Builder explain(Optional<? extends com.styra.opa.sdk.models.shared.Explain> explain) {
            Utils.checkNotNull(explain, "explain");
            this.explain = explain;
            return this;
        }
