...
public class SDKMethodInterfaces {
    ...
    public interface MethodCallExecutePolicy {
        com.styra.opa.sdk.models.operations.ExecutePolicyResponse executePolicy(
    ...
    public interface MethodCallExecutePolicyWithInput {
        com.styra.opa.sdk.models.operations.ExecutePolicyWithInputResponse executePolicyWithInput(
    ...
    public interface MethodCallHealth {
        com.styra.opa.sdk.models.operations.HealthResponse health(
